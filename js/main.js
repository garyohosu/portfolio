...
const translations = {
    ja: {
        ...
        stat4_number: '先駆者',
        stat4_label: 'CVW手法研究',
        achievement_detail_1_title: 'Quoraで24,000人以上のフォロワー',
        achievement_detail_1_desc: '技術系Q&Aプラットフォームで多くの支持を獲得',
        achievement_detail_2_title: '複数プラットフォームでの情報発信',
        achievement_detail_2_desc: 'note、X（Twitter）、Quora、GitHubで積極的に活動',
        achievement_detail_3_title: 'CVW手法の先駆的研究',
        achievement_detail_3_desc: '人間とAIの協働創作手法において先駆的な活動を展開',
        achievement_detail_4_title: '最新AI開発ツールに関する実践記事',
        achievement_detail_4_desc: 'Gemini CLI、Cline MCP、Cursorなどの実践的な記事を多数執筆',
    ...
    en: {
        ...
        stat1_number: '24,000+',
        stat1_label: 'Total Followers',
        stat2_number: '6',
        stat2_label: 'Active Platforms',
        stat3_number: '10M+',
        stat3_label: 'Total Views',
        stat4_number: '60K+',
        stat4_label: 'Total Upvotes',
        achievement_detail_1_title: '24,000+ Followers on Quora',
        achievement_detail_1_desc: 'Recognized on a major Q&A platform for authentic cultural insights',
        achievement_detail_2_title: 'Multi-Platform Presence',
        achievement_detail_2_desc: 'Active on note, X (Twitter), Quora, and GitHub sharing knowledge',
        achievement_detail_3_title: 'Pioneer in CVW Research',
        achievement_detail_3_desc: 'Leading research in human-AI collaborative creative methodology',
        achievement_detail_4_title: 'Practical AI Development Articles',
        achievement_detail_4_desc: 'Published expertise on Gemini CLI, Cursor, and other AI tools',
